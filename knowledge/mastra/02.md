...
## Calling an agentDirect link to Calling an agent
...
### From a workflow stepDirect link to From a workflow step
...
### From a toolDirect link to From a tool
...
### Using HTTP or curlDirect link to Using HTTP or curl
...
### Completion using onFinish()Direct link to completion-using-onfinish
...
### Using ZodDirect link to Using Zod
...
### With Tool CallingDirect link to With Tool Calling
...
## Working with imagesDirect link to Working with images
