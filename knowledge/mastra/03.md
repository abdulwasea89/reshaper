...
## Creating a toolDirect link to Creating a tool
...
## Adding tools to an agentDirect link to Adding tools to an agent
...
## Cancelling tool execution with AbortSignalDirect link to cancelling-tool-execution-with-abortsignal
...
## AI SDK Tool FormatDirect link to AI SDK Tool Format
