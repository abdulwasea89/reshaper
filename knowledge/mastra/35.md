...
### Step 1: Next.js ConfigurationDirect link to Step 1: Next.js Configuration
...
### Step 3: Configure your providersDirect link to Step 3: Configure your providers

If you're using Next.js, you have two options for setting up OpenTelemetry instrumentation: 

#### Option 1: Using a Custom ExporterDirect link to Option 1: Using a Custom Exporter
...
#### Option 2: Using Vercel's Otel SetupDirect link to Option 2: Using Vercel's Otel Setup
