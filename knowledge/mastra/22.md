...
## Memory Persistence ScopesDirect link to Memory Persistence Scopes

Working memory can operate in two different scopes, allowing you to choose how memory persists across conversations: 

### Thread-Scoped Memory (Default)Direct link to Thread-Scoped Memory (Default)
...
### Resource-Scoped MemoryDirect link to Resource-Scoped Memory
...
## Storage Adapter SupportDirect link to Storage Adapter Support

Resource-scoped working memory requires specific storage adapters that support the `mastra_resources`table: 

### ✅ Supported Storage AdaptersDirect link to ✅ Supported Storage Adapters
...
## Designing Effective TemplatesDirect link to Designing Effective Templates
...
### Alternative Template StylesDirect link to Alternative Template Styles
...
## Structured Working MemoryDirect link to Structured Working Memory
...
### Example: Schema-Based Working MemoryDirect link to Example: Schema-Based Working Memory
...
## Choosing Between Template and SchemaDirect link to Choosing Between Template and Schema
...
## Example: Multi-step RetentionDirect link to Example: Multi-step Retention
...
## Setting Initial Working MemoryDirect link to Setting Initial Working Memory
...
### Setting Working Memory via Thread MetadataDirect link to Setting Working Memory via Thread Metadata
...
### Updating Working Memory ProgrammaticallyDirect link to Updating Working Memory Programmatically
...
### Direct Memory UpdateDirect link to Direct Memory Update
