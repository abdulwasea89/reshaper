...
## How Semantic Recall WorksDirect link to How Semantic Recall Works
...
## Recall configurationDirect link to Recall configuration
...
### Embedder configurationDirect link to Embedder configuration

Semantic recall relies on an [embedding model](/reference/memory/memory-class)to convert messages into embeddings. Mastra supports embedding models through the model router using `provider/model`strings, or you can use any [embedding model](https://sdk.vercel.ai/docs/ai-sdk-core/embeddings)compatible with the AI SDK. 

#### Using the Model Router (Recommended)Direct link to Using the Model Router (Recommended)
...
#### Using AI SDK PackagesDirect link to Using AI SDK Packages
...
#### Using FastEmbed (Local)Direct link to Using FastEmbed (Local)
...
### PostgreSQL Index OptimizationDirect link to PostgreSQL Index Optimization
...
## Viewing Recalled MessagesDirect link to Viewing Recalled Messages
