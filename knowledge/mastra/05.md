...
## When to use networksDirect link to When to use networks
...
## Creating an agent networkDirect link to Creating an agent network
...
### Writing descriptions for network primitivesDirect link to Writing descriptions for network primitives
...
#### Agent descriptionsDirect link to Agent descriptions
...
#### Workflow descriptionsDirect link to Workflow descriptions
...
#### Tool descriptionsDirect link to Tool descriptions
...
## Calling agent networksDirect link to Calling agent networks
...
#### Agent outputDirect link to Agent output
...
## Workflow exampleDirect link to Workflow example
...
### Tool exampleDirect link to Tool example
