...
export default async function Layout({ children }: Readonly<{ children: ReactNode }>) {
  ...
  return (
    <SidebarProvider defaultOpen={defaultOpen} className="bg-black">
      ...
      <SidebarInset
        ...
        className={cn(
          ...
          "max-[113rem]:peer-data-[variant=inset]:!mr-2  bg-black min-[101rem]:peer-data-[variant=inset]:peer-data-[state=collapsed]:!mr-auto"
        )}
      >
         <header className="flex h-12 shrink-0 items-center gap-2  sticky top-0 z-50 rounded-t-md">
                    <div className="flex w-full items-center justify-between px-4 lg:px-6">
                        ...
                        {/* <div className="flex items-center gap-2 ">
                            ...
                            <Button size="sm" className="rounded-md bg-black dark:bg-white">
                                Schedule
                            </Button>
                            <Button size="sm" className="rounded-md bg-black dark:bg-white "    >
                                Post
