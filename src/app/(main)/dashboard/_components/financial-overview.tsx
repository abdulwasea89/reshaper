...
export function FinancialOverview() {
  ...
  // Fix for hydration error: only render chart on client
    ...
    return (
      <Card className="shadow-xs">
        <CardHeader>
          ...
          <CardAction>
            {/* Select can remain if it doesn't cause hydration issues, but safe to keep consistent */}
          </CardAction>
        </CardHeader>
        <CardContent>
          <Separator />
          <div className="flex flex-col items-start justify-between gap-2 py-5 md:flex-row md:items-stretch md:gap-0">
            {/* Static content can be rendered */}
          </div>
          <Separator />
